    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          // Only render on mobile - hide on desktop via display
          display: undefined,
        }}
        className="lg:hidden"
      />
                ...
                {hasChildren ? (
                  <>
                    <button
                      ...
                      style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%", background: "none", border: "none", color: "#ffffff", fontSize: "16px", fontWeight: 600, padding: "4px 0", cursor: "pointer", touchAction: "manipulation", textAlign: "left" }}
                    >
                  ...
                  <a
                    href={item.href}
                    onClick={onClose}
                    style={{ display: "block", padding: "4px 0", fontSize: "16px", fontWeight: 600, color: "#ffffff", textDecoration: "none" }}
                  >
                    {item.label}
                  </a>
                )}
        ...
        <div style={{ padding: "16px", borderTop: "1px solid rgba(255,255,255,0.1)", background: "rgba(0,0,0,0.95)", borderRadius: "0 0 16px 16px", flexShrink: 0 }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px", marginBottom: "10px" }}>
            <a
              ...
              style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "6px", padding: "10px 12px", borderRadius: "12px", border: "1px solid rgba(255,255,255,0.2)", fontSize: "12px", fontWeight: 500, color: "#ffffff", textDecoration: "none" }}
            >
              <Phone size={14} />
              <span>Call Us</span>
            </a>
          ...
          <a
            ...
            style={{ display: "block", textAlign: "center", width: "100%", padding: "10px", fontSize: "12px", fontWeight: 600 }}
          >
            Request a Quote
          </a>
        </div>
