...
export const metadata: Metadata = {
  title: "Security Uniforms | Guard Attire, Tactical Wear & Accessories | Amal Uniforms",
  description:
    "Explore professional security guard uniforms, tactical uniforms, patrol shirts, jackets, caps, and badges manufactured in Saudi Arabia by Amal Uniforms.",
};
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col text-slate-900 font-sans">
      ...
      <main className="flex-1 pt-18 lg:pt-20">
        ...
        <section className="relative overflow-hidden bg-slate-100 border-b border-slate-200/60 min-h-[380px] lg:min-h-[440px] flex items-center">
          {/* Seamless Full-Width Background Photo (Security personnel on right background) */}
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12 w-full">
            ...
            <div className="max-w-xl space-y-4 sm:space-y-5">
              ...
              {/* Highlights Pills - Tactical Steel Blue Theme */}
                ...
                {hero.highlights.map((item) => (
                  ...
                  >
                    <div className={`w-7 h-7 rounded-lg ${theme.badgeBg} ${theme.badgeText} ${theme.badgeBorder} border flex items-center justify-center`}>
                      {getIcon(item.icon, "w-4 h-4 text-blue-700")}
                    </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {subcategories.map((cat) => (
                <div
                  key={cat.id}
                  className="group bg-white rounded-2xl border border-slate-200/90 shadow-sm hover:shadow-xl hover:border-blue-500/40 transition-all duration-300 flex flex-col overflow-hidden"
                >
                  ...
                  <div className="relative h-64 w-full bg-slate-100 overflow-hidden">
                    ...
                    {/* Floating Icon Badge with Tactical Blue accent */}
