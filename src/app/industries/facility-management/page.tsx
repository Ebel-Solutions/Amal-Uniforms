...
export const metadata: Metadata = {
  title: "Facility Management Uniforms | Cleaning, Maintenance & Housekeeping Wear | Amal Uniforms",
  description:
    "Explore durable cleaning staff tunics, maintenance technician workwear, housekeeping apparel, and facility management supervisor uniforms manufactured in Saudi Arabia.",
};
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col text-slate-900 font-sans">
      ...
      <main className="flex-1 pt-18 lg:pt-20">
        ...
        <section className="relative overflow-hidden bg-slate-100 border-b border-slate-200/60 min-h-[380px] lg:min-h-[440px] flex items-center">
          {/* Seamless Full-Width Background Photo (Facility management crew on right background) */}
          <div className="absolute inset-0 z-0">
            <Image
              src={hero.heroImage}
              alt="Facility Management Uniforms"
              fill
              priority
            ...
            <div className="max-w-xl space-y-4 sm:space-y-5">
              ...
              <div className="flex flex-wrap items-center gap-3.5 pt-2">
                ...
                <a
                  ...
                  download="facility-management-catalog.pdf"
                  target="_blank"
              ...
              {/* Highlights Pills - Fresh Mint Cyan Theme */}
                ...
                {hero.highlights.map((item) => (
                  ...
                  >
                    <div className={`w-7 h-7 rounded-lg ${theme.badgeBg} ${theme.badgeText} ${theme.badgeBorder} border flex items-center justify-center`}>
                      {getIcon(item.icon, "w-4 h-4 text-cyan-700")}
                    </div>
        ...
        <section id="subcategories" className="py-10 lg:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {/* Grid of Subcategories (4 Cards) */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              {subcategories.map((cat) => (
                <div
                  key={cat.id}
                  className="group bg-white rounded-2xl border border-slate-200/90 shadow-sm hover:shadow-xl hover:border-cyan-500/40 transition-all duration-300 flex flex-col overflow-hidden"
                >
                  ...
                  <div className="relative h-64 w-full bg-slate-100 overflow-hidden">
                    ...
                    {/* Floating Icon Badge with Cyan accent */}
                    <div className="absolute bottom-3 left-3 w-10 h-10 rounded-full bg-white/95 backdrop-blur-xs text-cyan-700 shadow-md border border-slate-200/80 flex items-center justify-center">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {whyChoose.items.map((item) => (
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-cyan-50 text-cyan-700 border border-cyan-200 flex items-center justify-center mb-2">
        ...
        <ServiceCtaBanner
          ...
          imageAlt="Facility management uniforms"
        />
