...
export default function HealthcareIndustryPage() {
  const { hero, section, subcategories, whyChoose, ctaBanner, trustBadges } =
    healthcareData;
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col text-slate-900 font-sans">
      ...
      <main className="flex-1 pt-18 lg:pt-20">
        ...
        <section className="relative overflow-hidden bg-slate-100 border-b border-slate-200/60 min-h-[380px] lg:min-h-[440px] flex items-center">
          {/* Seamless Full-Width Background Photo (Doctors on right, hospital corridor background) */}
            ...
            <div className="max-w-xl space-y-4 sm:space-y-5">
              ...
              <div className="flex flex-wrap items-center gap-4 sm:gap-6 pt-5 border-t border-slate-300/70">
                {hero.highlights.map((item) => (
                  ...
                  >
                    <div className="w-7 h-7 rounded-lg bg-teal-500/15 text-teal-800 border border-teal-500/30 flex items-center justify-center">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-8">
              {subcategories.map((cat) => (
                <div
                  key={cat.id}
                  className="group bg-white rounded-2xl border border-slate-200/90 shadow-sm hover:shadow-xl hover:border-teal-500/40 transition-all duration-300 flex flex-col overflow-hidden"
                >
                  ...
                  <div className="relative h-64 w-full bg-slate-100 overflow-hidden">
                    ...
                    {/* Floating Icon Badge */}
                    <div className="absolute bottom-3 left-3 w-10 h-10 rounded-full bg-white/95 backdrop-blur-xs text-teal-700 shadow-md border border-slate-200/80 flex items-center justify-center">
                  ...
                  <div className="p-5 sm:p-6 flex-1 flex flex-col justify-between space-y-4">
                    <div>
                      <h3 className="text-xl font-bold text-navy-950 group-hover:text-teal-700 transition-colors mb-2">
                        {cat.title}
                      </h3>
                    ...
                    <div className="pt-2 border-t border-slate-100">
                      <Link
                        ...
                        className="inline-flex items-center gap-1.5 text-sm font-semibold text-teal-700 hover:text-teal-900 group/link"
                      >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {whyChoose.items.map((item) => (
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-teal-50 text-teal-700 border border-teal-100 flex items-center justify-center mb-2">
            ...
            <div className="flex-1 flex flex-col justify-center px-6 py-10 sm:px-10 lg:py-14 lg:pl-6 lg:pr-10 space-y-5">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-1">
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-teal-500 text-navy-950 font-bold text-sm rounded-xl hover:bg-teal-400 transition-colors shadow-md group"
                >
